...
import { DynamicRoundDetailView } from '@/app/admin/[secretPath]/dashboard/dynamic-round-detail-view';
...
function buildDynamicRoundQueryKey(
...
export function DynamicRoundRegistrationsView() {
  ...
  const queryKey = buildDynamicRoundQueryKey(
    targetAudience,
    committee,
    firstPreferenceCommittee,
    country,
  ...
  const performFetch = useCallback(
    (skipCache: boolean) => {
      ...
      const url = `${appConfig.backendUrl}/api/admin/dynamic-round-registrations?${queryParams}`;
