        ...
        >
          ...
          <div className="space-y-6 text-gray-300 leading-8">
            ...
            <p>
              ...
              United Nations Human Rights Council (UNHRC) at VCEMUN 2025. As the
              principal UN body tasked with upholding and protecting fundamental
              human rights, this committee stands at the forefront of addressing
              some of the most pressing and sensitive issues of our time. This
              year, we delve into a matter of profound global
            ...
            <p>
              ...
              veteran refines theirs. Every contribution matter, and I encourage
              each of you to research diligently, debate passionately, and
              negotiate thoughtfully as we work towards effective resolutions.
            </p>
            <p>
              At VCEMUN 2025, we strive to create an environment that is both
              intellectually stimulating and inclusive—where a first-time
            ...
            <p>
              We are excited to welcome you to what promises to be an enriching
              and transformative UNHRC session at VCEMUN 2025!
            </p>
            <div className="pt-3">
      ...
      <div className="mt-[18vh] container mx-auto px-4">
        ...
        >
          ...
          <div className="space-y-6 text-gray-300 leading-8">
            ...
            <p>
              It is my distinct honour and privilege to welcome you to the
              Economic and Social Council (ECOSOC) at VCEMUN 2025. As one of the
              principal organs of the United Nations, ECOSOC plays a crucial
              role in fostering international cooperation on economic, social,
              and environmental issues. This year, we turn our attention to a
              critical and pressing global challenge—Combating Illicit Trading
              and Wildlife Resource Trafficking.
            </p>
            <p>
              Illicit wildlife trade is one of the largest and most profitable
              transnational crimes, fuelling environmental destruction, species
              extinction, and organized criminal networks. Beyond its
              devastating impact on biodiversity, this illegal industry
              threatens global security, economic stability, and the livelihoods
              of communities that depend on sustainable ecosystems. As
              delegates, you will be tasked with formulating innovative and
              actionable solutions to dismantle trafficking networks, strengthen
              enforcement mechanisms, and promote sustainable alternatives.
            </p>
            <p>
              At VCEMUN, we aim to foster an intellectually stimulating and
              collaborative environment where delegates of all experience levels
              can engage meaningfully in diplomacy and problem-solving. Whether
              you are a first-time participant or a seasoned MUN veteran, your
              contributions will be instrumental in shaping discussions that
              lead to effective policy recommendations. I encourage you to
              research thoroughly, debate passionately, and negotiate
              strategically as we work towards pragmatic solutions that balance
              conservation efforts with economic and social realities.
            </p>
            <p>
              This committee promises to challenge your perspectives, sharpen
              your diplomatic acumen, and leave you with invaluable experiences.
            </p>
            <p>
        ...
        >
          ...
          <div className="space-y-6 text-gray-300 leading-8">
            <p>
              ...
              Press plays a crucial role in documenting, analyzing, and bringing
              to light the dynamic debates and negotiations that unfold within
              each committee.
            </p>
            <p>
              ...
              influences global policies, the responsibility of the press is to
              present unbiased, factual, and insightful coverage. At VCEMUN, our
              team of reporters, photographers, and analysts will work
              tirelessly to ensure that every perspective is heard, every debate
              is recorded, and every moment of diplomacy is captured.
            </p>
            <p>
              Throughout the conference, the IP Committee will be engaged in:
              <br />
              Live Reporting: Delivering timely updates on crucial discussions.
              <br />
              ...
              <br />
              Media Coverage: Showcasing the spirit of VCEMUN through compelling
              storytelling.
            </p>
            <p>
              We encourage all delegates to interact with our journalists, share
              your viewpoints, and contribute to the dialogue that extends
              beyond committee walls. Your words and actions will shape not only
              resolutions but also the narrative of this conference.
            </p>
            <p>
