...
/**
 * Payment Step
 * Collects: Transaction ID and Payment Screenshot
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <p className="text-xs text-muted-foreground">
              Upload a screenshot of your payment confirmation (Max 10MB,
              JPEG/JPG/PNG/WebP). The image will be compressed and securely
              stored.
            </p>
            {previewUrl && (
