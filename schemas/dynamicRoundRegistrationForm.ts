...
/**
 * Dynamic Round Registration Form Schema
 * Validates all registration data for Dynamic Round participants
 *
 * Prices:
 * - In-House (VCE): ₹800
 * - Other Colleges: ₹1500
 */
export const dynamicRoundRegistrationSchema = z
  .object({
 ...
 */
export type DynamicRoundRegistrationSchema = z.infer<
  typeof dynamicRoundRegistrationSchema
>;
